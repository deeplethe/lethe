...
<p align="center">
  <a href="https://pypi.org/project/pylethe/"><img src="https://img.shields.io/pypi/v/pylethe.svg?style=flat-square&color=blue&label=PyPI" alt="PyPI" /></a>
...
The Greek word for *truth* — `ἀλήθεια` / **aletheia** — is built on
*lethe* itself: `a-` (un-) + `lethe`.  **Truth is born of forgetting.**
